...
<?php
    ...
    <div class="container-fluid text-light" 
        ...
        <div class="row justify-content-center align-items-center min-vh-100 px-3">
            <div class="col-lg-8 col-md-10 mt-5 bg-dark bg-opacity-50 p-4 rounded d-none d-md-block">
            ...
            <div class="col-lg-8 col-md-10 my-5 bg-dark bg-opacity-50 p-4 rounded d-block d-md-none">
                <h1 class="text-center">About Us</h1>
