  ...
  <div class="d-flex">
    ...
    <div class="d-flex flex-column bg-light vh-100 p-3" style="width: 300px;">
      ...
      <div class="list-group flex-grow-1">
        <a href="<?php echo Config::indexPathMember() ?>?action=dashboard" class="list-group-item list-group-item-action active">
        ...
        <a href="<?php echo Config::indexPathMember() ?>?action=viewMyLibrary" class="list-group-item list-group-item-action">
          <i class="fas fa-book m-2"></i> My Library
        </a>
        <a href="<?php echo Config::indexPathMember() ?>?action=viewborrowhistory" class="list-group-item list-group-item-action">
        ...
        <a href="<?php echo Config::indexPathMember() ?>?action=aboutsoftware" class="list-group-item list-group-item-action">
