...
<body>
  ...
  <div id="sidepanel" class="bg-light text-dark row-gap-2 d-flex flex-column p-2">
    ...
    <a href="<?= Config::indexPathMember() ?>?action=dashboard"
      ...
      <div class="nav-icon ms-1"><i class="fas fa-gauge"></i></div>
    ...
    <a href="<?= Config::indexPathMember() ?>?action=profile"
      ...
      <div class="nav-icon ms-1"><i class="fas fa-user"></i></div>
    ...
    <a href="<?= Config::indexPathMember() ?>?action=viewMyLibrary"
      ...
      <div class="nav-icon ms-1"><i class="fas fa-book"></i></div>
    ...
    <a href="<?= Config::indexPathMember() ?>?action=viewborrowhistory"
      ...
      <div class="nav-icon ms-1"><i class="fas fa-history"></i></div>
    ...
    <a href="<?= Config::indexPathMember() ?>?action=reservedbooks"
      ...
      <div class="nav-icon ms-1"><i class="fas fa-bookmark"></i></div>
    ...
    <a href="<?= Config::indexPathMember() ?>?action=aboutsoftware"
      ...
      <div class="nav-icon ms-1"><i class="fas fa-laptop-code"></i></div>
    ...
    <!-- User Profile -->
    <a href="<?= Config::indexPathMember() ?>?action=profile"
       class="nav-link rounded d-flex align-items-center <?= $current_action == 'profile' ? 'bg-dark text-white' : 'text-dark'; ?>">
    ...
    <a href="index.php?action=logout"
      ...
      <div class="nav-icon ms-1"><i class="fas fa-sign-out-alt"></i></div>
