                    ...
                    <div class="row g-3 d-flex justify-content-evenly">
                        <div class="col-12 col-md-5 mr-3 text-right pt-3 box rounded">
                            <div class="d-flex justify-content-end m-1">
                                <button  class="btn btn-light"><a class="text-decoration-none" href="<?php echo Config::indexPath() ?>?action=showissuebook">Issue Books</a></button>
                            </div>
                        </div>

                        <div class="col-12 col-md-5 ml-4 text-right pt-3 box rounded">
                            <div class="d-flex justify-content-end m-1">
                                <button class="btn btn-light"><a class="text-decoration-none" href="<?php echo Config::indexPath() ?>?action=showviewissuebook">View Issued Books</a></button>
                            </div>
                        </div>
                    </div>
                </div>
