                ...
                <nav class="navbar p-md-4 navbar-light bg-light w-100">
                    <div class="d-flex align-items-center w-100 justify-content-between">
                        ...
                        <div class="d-flex align-items-center">
                            <button id="generateReport" class="btn btn-outline-dark me-3" onclick="generateDeactiveMemberReport();">
            ...
            <div class="row m-4">
                ...
                <div class="col-md-6 mt-2">
                    <div class="d-flex">
                        ...
                        <button type="submit" name="search" class="btn btn-primary mx-3 px-3" onclick="loadMembers(1,'Deactive');"><i class="fa fa-search"></i></button>
                    </div>
                </div>
            </div>
