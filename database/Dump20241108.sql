...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-09-08 16:51:20',NULL),('diagnostics.include_raw','OFF','2024-09-08 16:51:20',NULL),('ps_thread_trx_info.max_length','65535','2024-09-08 16:51:20',NULL),('statement_performance_analyzer.limit','100','2024-09-08 16:51:20',NULL),('statement_performance_analyzer.view',NULL,'2024-09-08 16:51:20',NULL),('statement_truncate_len','64','2024-09-08 16:51:20',NULL);
...
-- Dump completed on 2024-11-08 11:04:54
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
...
CREATE TABLE `book` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_book_book_status1_idx` (`book_status_id`),
  KEY `fk_book_category1_idx` (`category_id`),
  CONSTRAINT `fk_book_book_status1` FOREIGN KEY (`book_status_id`) REFERENCES `book_status` (`id`),
...
CREATE TABLE `borrow` (
  ...
  KEY `fk_borrow_member1_idx` (`member_id`),
  CONSTRAINT `fk_borrow_book1` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`),
  CONSTRAINT `fk_borrow_member1` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fee_payment` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_fee_payment_member1_idx` (`member_id`),
  KEY `fk_fee_payment_invoice1_idx` (`invoice_id`),
  CONSTRAINT `fk_fee_payment_invoice1` FOREIGN KEY (`invoice_id`) REFERENCES `invoice` (`id`),
  CONSTRAINT `fk_fee_payment_member1` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fine_payment` (
  ...
  `invoice_id` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_fine_payment_member1_idx` (`member_id`),
  KEY `fk_fine_payment_borrow1_idx` (`borrow_id`),
  KEY `fk_fine_payment_invoice1_idx` (`invoice_id`),
  CONSTRAINT `fk_fine_payment_borrow1` FOREIGN KEY (`borrow_id`) REFERENCES `borrow` (`id`),
  CONSTRAINT `fk_fine_payment_invoice1` FOREIGN KEY (`invoice_id`) REFERENCES `invoice` (`id`),
  CONSTRAINT `fk_fine_payment_member1` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `reservation` (
  ...
  CONSTRAINT `fk_reservation_book1` FOREIGN KEY (`book_id`) REFERENCES `book` (`id`),
  CONSTRAINT `fk_reservation_member1` FOREIGN KEY (`member_id`) REFERENCES `member` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `return` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_return_borrow1_idx` (`borrow_id`),
  KEY `fk_return_fine_payment1_idx` (`fine_payment_id`),
  CONSTRAINT `fk_return_borrow1` FOREIGN KEY (`borrow_id`) REFERENCES `borrow` (`id`),
  CONSTRAINT `fk_return_fine_payment1` FOREIGN KEY (`fine_payment_id`) REFERENCES `fine_payment` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `staff` (
  ...
  CONSTRAINT `fk_staff_role1` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `member` WRITE;
/*!40000 ALTER TABLE `member` DISABLE KEYS */;
INSERT INTO `member` VALUES (15,'U-1111-2222','200180300611','Dulakshi','Gammanpila','0704567144','134, Ernest place, Moratuwa','dulakshigamma@gmail.com','Dvg$11029',NULL,'assets/profimg/67239b81c2141-download.jpeg',1),(16,'U-2222-3333','200230422844','Saman','Perera','0711234567','12, perara mw,Nugegoda','saman@gmail.com','Saman!123',NULL,NULL,0);
/*!40000 ALTER TABLE `member` ENABLE KEYS */;
UNLOCK TABLES;
