...
-- Dumping data for table library_db.borrow: ~3 rows (approximately)
INSERT INTO `borrow` (`borrow_id`, `borrow_date`, `due_date`, `return_date`, `borrow_book_id`, `borrow_member_id`) VALUES
	...
	(37, '2025-04-06', '2025-04-02', NULL, 'B-000009', 1);
...
-- Dumping data for table library_db.member: ~12 rows (approximately)
INSERT INTO `member` (`id`, `nic`, `fname`, `lname`, `mobile`, `address`, `email`, `date_joined`, `vcode`, `profile_img`, `status_id`) VALUES
	...
	(19, '200178377654', 'Nimal', 'Perera', '0711232124', 'mmddd', 'dulakshmma@gmail.com', '2025-04-04', NULL, NULL, 1),
	(20, '881234567V', 'Nimal', 'Perera', '0771234567', 'Colombo 03', 'nimalp@example.com', '2025-04-07', NULL, NULL, 1),
	(21, '200023433988', 'Saman', 'Fernando', '0712233445', 'Kandy', 'samanf@example.com', '2025-04-07', NULL, NULL, 1),
	(22, '200456766544', 'Anusha', 'Silva', '0755678901', 'Galle', 'anushas@example.com', '2025-04-07', NULL, NULL, 1),
	(23, '912345678V', 'Tharindu', 'Jayasuriya', '0769988776', 'Matara', 'tharinduj@example.com', '2025-04-07', NULL, NULL, 1),
	(24, '862345671V', 'Ishara', 'Rathnayake', '0781112233', 'Negombo', 'isharar@example.com', '2025-04-07', NULL, NULL, 1),
	(25, '200845665434', 'Chamara', 'Dissanayake', '0701234987', 'Kurunegala', 'chamarad@example.com', '2025-04-07', NULL, NULL, 1),
	(26, '200788544555', 'Dinithi', 'Weerasinghe', '0776543210', 'Batticaloa', 'dinithiw@example.com', '2025-04-07', NULL, NULL, 1),
	(27, '201045654345', 'Harsha', 'Karunaratne', '0711122334', 'Anuradhapura', 'harshak@example.com', '2025-04-07', NULL, NULL, 1),
	(28, '881112223V', 'Kavindi', 'Samarasinghe', '0723344556', 'Nuwara Eliya', 'kavindis@example.com', '2025-04-07', NULL, NULL, 1),
	(29, '871234897V', 'Supun', 'Abeykoon', '0751233214', 'Badulla', 'supuna@example.com', '2025-04-07', NULL, NULL, 1);
...
-- Dumping data for table library_db.member_login: ~12 rows (approximately)
INSERT INTO `member_login` (`member_login_id`, `member_id`, `password`, `memberId`, `remember_token`) VALUES
	(1, 'M-000001', '$2y$10$njNTPa8KpI2Ye8X66mZP6uZqznZhafdlDvIhqu5pDBJWRIm.xX0BG', 1, '$2y$10$wBUOQhHKXLDx35Cx3H1nf./7yW6VsyIhE4MZpjokSpITb13rupaQC'),
	(2, 'M-000002', ']*W2o}J<i<&F', 19, NULL),
	(27, 'M-000003', 'Acv$%1244', 20, NULL),
	(28, 'M-000004', '1H@&HGnjkl', 21, NULL),
	(29, 'M-000005', 'LKaJ1^%123', 22, NULL),
	(30, 'M-000006', '123QWasd#@', 23, NULL),
	(31, 'M-000007', 'QNH%$#wds11', 24, NULL),
	(32, 'M-000008', '13hdA87$$', 25, NULL),
	(33, 'M-000009', 'Vish1265418', 26, NULL),
	(34, 'M-000010', 'DE18#$sh', 27, NULL),
	(35, 'M-000011', '952FGrt$*', 28, NULL),
	(36, 'M-000012', 'TYH38&!1sh', 29, NULL);
...
INSERT INTO `reservation` (`reservation_id`, `reservation_date`, `reservation_member_id`, `reservation_book_id`, `status_id`, `notified_date`, `expiration_date`) VALUES
	...
	(49, '2025-04-07', 1, 'B-000006', 1, NULL, '2025-04-14');
...
INSERT INTO `staff` (`id`, `nic`, `fname`, `lname`, `mobile`, `address`, `email`, `vcode`, `profile_img`, `role_id`, `status_id`) VALUES
	...
	(2, '200180300611', 'Test1', 'Test2', '0704567123', 'Main road, Kandy', 'dulakshigamma@gmail.com', '67f4b17804757', NULL, 2, 1),
	(14, '200180300601', 'Test1', 'Test2', '0704567123', 'Main road, Kandy', 'aa@gmail.com', NULL, NULL, 2, 2),
	(15, '200180300610', 'Dulakshi', 'Gammanpila', '0704567123', 'Main road, Kandy', 'iddcgammanpila@gmail.com', NULL, NULL, 1, 1);
...
-- Dumping data for table library_db.staff_key: ~2 rows (approximately)
INSERT INTO `staff_key` (`id`, `email`, `key_value`, `role_id`) VALUES
	(3, 'dulakshigamma@gmail.com', 'B06F220789EDCD8FC6B95A7DCB7C3EC5', 2),
	(4, 'iddcgammanpila@gmail.com', 'E1D9D36E0EDD55CC70149B51569BFA77', 1),
	(5, 'aa@gmail.com', '54EBB20E4B8DB8B4BF97DE18AF6C5FFE', 2);
...
-- Dumping data for table library_db.staff_login: ~3 rows (approximately)
INSERT INTO `staff_login` (`login_id`, `staff_id`, `password`, `staffId`, `remember_token`) VALUES
	(1, 'S-000001', '$2y$10$e0NRjIsvRv8l.CtB0Ev9lu5cUdI1nZrUeYdfuLjq/mg5PcgOz5o1u', 1, NULL),
	(2, 'S-000002', 'Asd!1234', 2, NULL),
	(8, 'S-000003', 'Dcg$11029', 14, NULL),
	(9, 'S-000004', '$2y$10$njNTPa8KpI2Ye8X66mZP6uZqznZhafdlDvIhqu5pDBJWRIm.xX0BG', 15, '$2y$10$PrjWiqpgMPTSjk78ruRQOOpCSAuEnHRdQZxpFu0pearzEFHGKtwlW');
